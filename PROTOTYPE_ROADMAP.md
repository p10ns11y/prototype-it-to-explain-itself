...
**Progress note**: Prototypes 1–5 complete. The Predictor seam is now exercised with real swapping + measurement. Next: Proto 6 (Synthetic Data Factory) to close the improvement loop using data from the evaluator.
